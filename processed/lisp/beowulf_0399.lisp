...
(text-analysis
 :text "Certes le «petit noyau» n’avait aucun rapport avec la société où
...
il était devant une femme de chambre."
 :tokens 346
 :processed-at "2025-03-16T02:18:14.217419"
 :entities (list
  (entity :text "Certes" :label "ORG" :start 0 :end 6) (entity :text "Swann," :label "ORG" :start 77 :end 83) (entity :text "Verdurin." :label "ORG" :start 232 :end 241) (entity :text "Mais" :label "ORG" :start 242 :end 246) (entity :text "Swann" :label "ORG" :start 247 :end 252) (entity :text "Saint-Germain," :label "ORG" :start 537 :end 551) (entity :text "Paris," :label "ORG" :start 750 :end 756) (entity :text "Swann" :label "ORG" :start 1372 :end 1377) (entity :text "Swann" :label "ORG" :start 1890 :end 1895)
 )
 :sentences (list
  (sentence :text "Certes le «petit noyau» n’avait aucun rapport avec la société où
fréquentait Swann, et de purs mondains auraient trouvé que ce n’était
pas la peine d’y occuper comme lui une situation exceptionnelle pour
se faire présenter chez les Verdurin" :start 0 :end 240) (sentence :text "Mais Swann aimait tellement les
femmes, qu’à partir du jour où il avait connu à peu près toutes celles
de l’aristocratie et où elles n’avaient plus rien eu à lui apprendre,
il n’avait plus tenu à ces lettres de naturalisation, presque des
titres de noblesse, que lui avait octroyées le faubourg Saint-Germain,
...
de prix en elle-même, mais lui permettant de s’improviser une
situation dans tel petit trou de province ou tel milieu obscur de
Paris, où la fille du hobereau ou du greffier lui avait semblé jolie" :start 241 :end 818) (sentence :text "Car le désir ou l’amour lui rendait alors un sentiment de vanité dont
il était maintenant exempt dans l’habitude de la vie (bien que ce fût
lui sans doute qui autrefois l’avait dirigé vers cette carrière
mondaine où il avait gaspillé dans les plaisirs frivoles les dons de
son esprit et fait servir son érudition en matière d’art à conseiller
...
l’ameublement de leurs hôtels), et qui lui faisait désirer de briller,
aux yeux d’une inconnue dont il s’était épris, d’une élégance que le
nom de Swann à lui tout seul n’impliquait pas" :start 819 :end 1410) (sentence :text "Il le désirait surtout
si l’inconnue était d’humble condition" :start 1411 :end 1473) (sentence :text "De même que ce n’est pas à un
autre homme intelligent qu’un homme intelligent aura peur de paraître
bête, ce n’est pas par un grand seigneur, c’est par un rustre qu’un
homme élégant craindra de voir son élégance méconnue" :start 1474 :end 1695) (sentence :text "Les trois quarts
des frais d’esprit et des mensonges de vanité qui ont été prodigués
depuis que le monde existe par des gens qu’ils ne faisaient que
diminuer, l’ont été pour des inférieurs" :start 1696 :end 1885) (sentence :text "Et Swann qui était simple et
négligent avec une duchesse, tremblait d’être méprisé, posait, quand
il était devant une femme de chambre" :start 1886 :end 2021)
 ))
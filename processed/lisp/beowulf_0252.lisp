...
(text-analysis
 :text "Ainsi passait la vie pour ma tante Léonie, toujours identique, dans la
...
ni personne eût jamais appris ce que j’avais entendu."
 :tokens 461
 :processed-at "2025-03-16T02:18:14.047010"
 :entities (list
  (entity :text "Léonie," :label "ORG" :start 35 :end 42) (entity :text "Préservé" :label "ORG" :start 185 :end 193) (entity :text "Françoise" :label "ORG" :start 472 :end 481) (entity :text "Comme" :label "ORG" :start 574 :end 579) (entity :text "Mais" :label "ORG" :start 736 :end 740) (entity :text "Combray," :label "ORG" :start 818 :end 826) (entity :text "Françoise" :label "ORG" :start 827 :end 836) (entity :text "Thiberzy." :label "ORG" :start 880 :end 889) (entity :text "Françoise," :label "ORG" :start 960 :end 970) (entity :text "«Monte" :label "ORG" :start 1094 :end 1100) (entity :text "Dieu" :label "ORG" :start 1995 :end 1999) (entity :text "«Dieu" :label "ORG" :start 2208 :end 2213) (entity :text "Octave" :label "ORG" :start 2333 :end 2339)
 )
 :sentences (list
  (sentence :text "Ainsi passait la vie pour ma tante Léonie, toujours identique, dans la
douce uniformité de ce qu’elle appelait avec un dédain affecté et une
tendresse profonde, son «petit traintrain»" :start 0 :end 183) (sentence :text "Préservé par tout le
monde, non seulement à la maison, où chacun ayant éprouvé l’inutilité
de lui conseiller une meilleure hygiène, s’était peu à peu résigné à
le respecter, mais même dans le village où, à trois rues de nous,
l’emballeur, avant de clouer ses caisses, faisait demander à Françoise
si ma tante ne «reposait pas»,--ce traintrain fut pourtant troublé une
fois cette année-là" :start 184 :end 572) (sentence :text "Comme un fruit caché qui serait parvenu à
maturité sans qu’on s’en aperçût et se détacherait spontanément,
survint une nuit la délivrance de la fille de cuisine" :start 573 :end 734) (sentence :text "Mais ses
douleurs étaient intolérables, et comme il n’y avait pas de sage-femme
à Combray, Françoise dut partir avant le jour en chercher une à
Thiberzy" :start 735 :end 888) (sentence :text "Ma tante, à cause des cris de la fille de cuisine, ne put
reposer, et Françoise, malgré la courte distance, n’étant revenue que
très tard, lui manqua beaucoup" :start 889 :end 1048) (sentence :text "Aussi, ma mère me dit-elle dans la
matinée: «Monte donc voir si ta tante n’a besoin de rien" :start 1049 :end 1141) (sentence :text "» J’entrai
dans la première pièce et, par la porte ouverte, vis ma tante, couchée
sur le côté, qui dormait; je l’entendis ronfler légèrement" :start 1142 :end 1282) (sentence :text "J’allais
m’en aller doucement mais sans doute le bruit que j’avais fait était
intervenu dans son sommeil et en avait «changé la vitesse», comme on
dit pour les automobiles, car la musique du ronflement s’interrompit
une seconde et reprit un ton plus bas, puis elle s’éveilla et tourna à
...
habitude qu’elle avait prise de se parler à mi-voix à elle-même quand
elle se croyait seule, elle murmura: «Dieu soit loué! nous n’avons
comme tracas que la fille de cuisine qui accouche" :start 1283 :end 2287) (sentence :text "Voilà-t-il pas que
je rêvais que mon pauvre Octave était ressuscité et qu’il voulait me
faire faire une promenade tous les jours!» Sa main se tendit vers son
chapelet qui était sur la petite table, mais le sommeil recommençant
ne lui laissa pas la force de l’atteindre: elle se rendormit,
tranquillisée, et je sortis à pas de loup de la chambre sans qu’elle
ni personne eût jamais appris ce que j’avais entendu" :start 2288 :end 2699)
 ))
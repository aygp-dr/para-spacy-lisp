...
(text-analysis
 :text "Maman passa cette nuit-là dans ma chambre; au moment où je venais de
...
pourrais me décider à donner à cet enfant quelque chose de mal écrit.»"
 :tokens 1039
 :processed-at "2025-03-16T02:18:13.828927"
 :entities (list
  (entity :text "Maman" :label "ORG" :start 0 :end 5) (entity :text "Même" :label "ORG" :start 253 :end 257) (entity :text "Pour" :label "ORG" :start 1072 :end 1076) (entity :text "Maman" :label "ORG" :start 1292 :end 1297) (entity :text "Françoise," :label "ORG" :start 1447 :end 1457) (entity :text "«Mais" :label "ORG" :start 1628 :end 1633) (entity :text "Madame," :label "ORG" :start 1634 :end 1641) (entity :text "Monsieur" :label "ORG" :start 1652 :end 1660) (entity :text "«Mais" :label "ORG" :start 1699 :end 1704) (entity :text "Françoise," :label "ORG" :start 1730 :end 1740) (entity :text "Françoise" :label "ORG" :start 2210 :end 2219) (entity :text "«Non" :label "ORG" :start 3172 :end 3176) (entity :text "Mais" :label "ORG" :start 3213 :end 3217) (entity :text "Certes," :label "ORG" :start 3511 :end 3518) (entity :text "Cette" :label "ORG" :start 3971 :end 3976) (entity :text "Comme" :label "ORG" :start 4178 :end 4183) (entity :text "«Voilà" :label "ORG" :start 4244 :end 4250) (entity :text "Voyons," :label "ORG" :start 4360 :end 4367) (entity :text "Mais" :label "ORG" :start 4499 :end 4503) (entity :text "Pense" :label "ORG" :start 4642 :end 4647) (entity :text "Jour" :label "ORG" :start 4978 :end 4982) (entity :text "Mare" :label "ORG" :start 5038 :end 5042) (entity :text "Diable," :label "ORG" :start 5046 :end 5053) (entity :text "François" :label "ORG" :start 5054 :end 5062) (entity :text "Champi," :label "ORG" :start 5066 :end 5073) (entity :text "Petite" :label "ORG" :start 5077 :end 5083) (entity :text "Fadette" :label "ORG" :start 5084 :end 5091) (entity :text "Maîtres" :label "ORG" :start 5099 :end 5106) (entity :text "Sonneurs." :label "ORG" :start 5107 :end 5116) (entity :text "Musset," :label "ORG" :start 5185 :end 5192) (entity :text "Rousseau" :label "ORG" :start 5206 :end 5214) (entity :text "Mais" :label "ORG" :start 5514 :end 5518) (entity :text "George" :label "ORG" :start 5932 :end 5938) (entity :text "Sand." :label "ORG" :start 5939 :end 5944)
 )
 :sentences (list
  (sentence :text "Maman passa cette nuit-là dans ma chambre; au moment où je venais de
commettre une faute telle que je m’attendais à être obligé de quitter
la maison, mes parents m’accordaient plus que je n’eusse jamais obtenu
d’eux comme récompense d’une belle action" :start 0 :end 251) (sentence :text "Même à l’heure où elle se
manifestait par cette grâce, la conduite de mon père à mon égard
gardait ce quelque chose d’arbitraire et d’immérité qui la
caractérisait et qui tenait à ce que généralement elle résultait
plutôt de convenances fortuites que d’un plan prémédité" :start 252 :end 523) (sentence :text "Peut-être
même que ce que j’appelais sa sévérité, quand il m’envoyait me
coucher, méritait moins ce nom que celle de ma mère ou ma grand’mère,
car sa nature, plus différente en certains points de la mienne que
n’était la leur, n’avait probablement pas deviné jusqu’ici combien
...
savaient bien; mais elles m’aimaient assez pour ne pas consentir à
m’épargner de la souffrance, elles voulaient m’apprendre à la dominer
afin de diminuer ma sensibilité nerveuse et fortifier ma volonté" :start 524 :end 1070) (sentence :text "Pour
mon père, dont l’affection pour moi était d’une autre sorte, je ne
sais pas s’il aurait eu ce courage: pour une fois où il venait de
comprendre que j’avais du chagrin, il avait dit à ma mère: «Va donc le
consoler" :start 1071 :end 1289) (sentence :text "» Maman resta cette nuit-là dans ma chambre et, comme pour ne
gâter d’aucun remords ces heures si différentes de ce que j’avais eu
le droit d’espérer, quand Françoise, comprenant qu’il se passait
quelque chose d’extraordinaire en voyant maman assise près de moi, qui
me tenait la main et me laissait pleurer sans me gronder, lui demanda:
«Mais Madame, qu’a donc Monsieur à pleurer ainsi?» maman lui répondit:
«Mais il ne sait pas lui-même, Françoise, il est énervé; préparez-moi
vite le grand lit et montez vous coucher" :start 1290 :end 1809) (sentence :text "» Ainsi, pour la première
fois, ma tristesse n’était plus considérée comme une faute punissable
mais comme un mal involontaire qu’on venait de reconnaître
officiellement, comme un état nerveux dont je n’étais pas responsable;
j’avais le soulagement de n’avoir plus à mêler de scrupules à
l’amertume de mes larmes, je pouvais pleurer sans péché" :start 1810 :end 2153) (sentence :text "Je n’étais
pas non plus médiocrement fier vis-à-vis de Françoise de ce retour des
choses humaines, qui, une heure après que maman avait refusé de monter
dans ma chambre et m’avait fait dédaigneusement répondre que je
devrais dormir, m’élevait à la dignité de grande personne et m’avait
fait atteindre tout d’un coup à une sorte de puberté du chagrin,
d’émancipation des larmes" :start 2154 :end 2531) (sentence :text "J’aurais dû être heureux: je ne l’étais
pas" :start 2532 :end 2576) (sentence :text "Il me semblait que ma mère venait de me faire une première
concession qui devait lui être douloureuse, que c’était une première
abdication de sa part devant l’idéal qu’elle avait conçu pour moi, et
que pour la première fois, elle, si courageuse, s’avouait vaincue" :start 2577 :end 2841) (sentence :text "Il
me semblait que si je venais de remporter une victoire c’était contre
elle, que j’avais réussi comme auraient pu faire la maladie, des
chagrins, ou l’âge, à détendre sa volonté, à faire fléchir sa raison
et que cette soirée commençait une ère, resterait comme une triste
date" :start 2842 :end 3121) (sentence :text "Si j’avais osé maintenant, j’aurais dit à maman: «Non je ne veux
pas, ne couche pas ici" :start 3122 :end 3210) (sentence :text "» Mais je connaissais la sagesse pratique,
réaliste comme on dirait aujourd’hui, qui tempérait en elle la nature
ardemment idéaliste de ma grand’mère, et je savais que, maintenant que
le mal était fait, elle aimerait mieux m’en laisser du moins goûter le
plaisir calmant et ne pas déranger mon père" :start 3211 :end 3509) (sentence :text "Certes, le beau visage de
ma mère brillait encore de jeunesse ce soir-là où elle me tenait si
doucement les mains et cherchait à arrêter mes larmes; mais justement
il me semblait que cela n’aurait pas dû être, sa colère eût été moins
triste pour moi que cette douceur nouvelle que n’avait pas connue mon
enfance; il me semblait que je venais d’une main impie et secrète de
tracer dans son âme une première ride et d’y faire apparaître un
premier cheveu blanc" :start 3510 :end 3969) (sentence :text "Cette pensée redoubla mes sanglots et alors je
vis maman, qui jamais ne se laissait aller à aucun attendrissement
avec moi, être tout d’un coup gagnée par le mien et essayer de retenir
une envie de pleurer" :start 3970 :end 4176) (sentence :text "Comme elle sentit que je m’en étais aperçu, elle
me dit en riant: «Voilà mon petit jaunet, mon petit serin, qui va
rendre sa maman aussi bêtasse que lui, pour peu que cela continue" :start 4177 :end 4358) (sentence :text "Voyons, puisque tu n’as pas sommeil ni ta maman non plus, ne restons
pas à nous énerver, faisons quelque chose, prenons un de tes livres" :start 4359 :end 4496) (sentence :text "»
Mais je n’en avais pas là" :start 4497 :end 4524) (sentence :text "«Est-ce que tu aurais moins de plaisir si
je sortais déjà les livres que ta grand’mère doit te donner pour ta
fête? Pense bien: tu ne seras pas déçu de ne rien avoir après-demain?»
J’étais au contraire enchanté et maman alla chercher un paquet de
livres dont je ne pus deviner, à travers le papier qui les
enveloppait, que la taille courte et large, mais qui, sous ce premier
aspect, pourtant sommaire et voilé, éclipsaient déjà la boîte à
couleurs du Jour de l’An et les vers à soie de l’an dernier" :start 4525 :end 5025) (sentence :text "C’était
la Mare au Diable, François le Champi, la Petite Fadette et les
Maîtres Sonneurs" :start 5026 :end 5115) (sentence :text "Ma grand’mère, ai-je su depuis, avait d’abord choisi
les poésies de Musset, un volume de Rousseau et Indiana; car si elle
jugeait les lectures futiles aussi malsaines que les bonbons et les
pâtisseries, elles ne pensait pas que les grands souffles du génie
eussent sur l’esprit même d’un enfant une influence plus dangereuse et
moins vivifiante que sur son corps le grand air et le vent du large" :start 5116 :end 5512) (sentence :text "Mais mon père l’ayant presque traitée de folle en apprenant les livres
qu’elle voulait me donner, elle était retournée elle-même à
Jouy-le-Vicomte chez le libraire pour que je ne risquasse pas de ne
pas avoir mon cadeau (c’était un jour brûlant et elle était rentrée si
souffrante que le médecin avait averti ma mère de ne pas la laisser se
fatiguer ainsi) et elle s’était rabattue sur les quatre romans
champêtres de George Sand" :start 5513 :end 5943) (sentence :text "«Ma fille, disait-elle à maman, je ne
pourrais me décider à donner à cet enfant quelque chose de mal écrit" :start 5944 :end 6051) (sentence :text "»" :start 1290 :end 1291)
 ))
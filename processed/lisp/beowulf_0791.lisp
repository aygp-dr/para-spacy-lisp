...
(text-analysis
 :text "Par cet amour Swann avait été tellement détaché de tous les intérêts,
...
et l’art de savoir bien faire une commande."
 :tokens 470
 :processed-at "2025-03-16T02:18:14.623319"
 :entities (list
  (entity :text "Swann" :label "ORG" :start 14 :end 19) (entity :text "Odette" :label "ORG" :start 295 :end 301) (entity :text "Saint-Simon," :label "ORG" :start 944 :end 956) (entity :text "Maintenon," :label "ORG" :start 1049 :end 1059) (entity :text "Lulli." :label "ORG" :start 1101 :end 1107) (entity :text "Swann," :label "ORG" :start 1215 :end 1221) (entity :text "Swann»," :label "ORG" :start 1425 :end 1432) (entity :text "Charles" :label "ORG" :start 1483 :end 1490) (entity :text "Swann," :label "ORG" :start 1491 :end 1497) (entity :text "Parme" :label "ORG" :start 1601 :end 1606) (entity :text "Odette" :label "ORG" :start 1671 :end 1677) (entity :text "Crapote" :label "ORG" :start 2028 :end 2035) (entity :text "Jauret," :label "ORG" :start 2079 :end 2086) (entity :text "Chevet" :label "ORG" :start 2103 :end 2109) (entity :text "Mais" :label "ORG" :start 2317 :end 2321)
 )
 :sentences (list
  (sentence :text "Par cet amour Swann avait été tellement détaché de tous les intérêts,
que quand par hasard il retournait dans le monde en se disant que ses
relations comme une monture élégante qu’elle n’aurait pas d’ailleurs
su estimer très exactement, pouvaient lui rendre à lui-même un peu de
prix aux yeux d’Odette (et ç’aurait peut-être été vrai en effet si
...
qui était un de ses auteurs favoris, la mécanique des journées, le
menu des repas de Mme de Maintenon, ou l’avarice avisée et le grand
train de Lulli" :start 0 :end 1106) (sentence :text "Et dans la faible mesure où ce détachement n’était pas
absolu, la raison de ce plaisir nouveau que goûtait Swann, c’était de
pouvoir émigrer un moment dans les rares parties de lui-même restées
presque étrangères à son amour, à son chagrin" :start 1107 :end 1347) (sentence :text "A cet égard cette
personnalité, que lui attribuait ma grand’tante, de «fils Swann»,
distincte de sa personnalité plus individuelle de Charles Swann, était
celle où il se plaisait maintenant le mieux" :start 1348 :end 1547) (sentence :text "Un jour que, pour
l’anniversaire de la princesse de Parme (et parce qu’elle pouvait
souvent être indirectement agréable à Odette en lui faisant avoir des
places pour des galas, des jubilés), il avait voulu lui envoyer des
fruits, ne sachant pas trop comment les commander, il en avait chargé
...
les fruits au même endroit, mais les raisins chez Crapote dont c’est
la spécialité, les fraises chez Jauret, les poires chez Chevet où
elles étaient plus belles, etc" :start 1548 :end 2143) (sentence :text ", «chaque fruit visité et examiné un
par un par moi»" :start 2144 :end 2196) (sentence :text "Et en effet, par les remerciements de la princesse,
il avait pu juger du parfum des fraises et du moelleux des poires" :start 2197 :end 2315) (sentence :text "Mais surtout le «chaque fruit visité et examiné un par un par moi»
avait été un apaisement à sa souffrance, en emmenant sa conscience
dans une région où il se rendait rarement, bien qu’elle lui appartînt
comme héritier d’une famille de riche et bonne bourgeoisie où
s’étaient conservés héréditairement, tout prêts à être mis à son
service dès qu’il le souhaitait, la connaissance des «bonnes adresses»
et l’art de savoir bien faire une commande" :start 2316 :end 2761)
 ))
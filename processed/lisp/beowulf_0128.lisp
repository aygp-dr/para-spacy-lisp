...
(text-analysis
 :text "Mais si les acteurs me préoccupaient ainsi, si la vue de Maubant
...
d’autres, qui était pour lui une intime amie."
 :tokens 316
 :processed-at "2025-03-16T02:18:13.922624"
 :entities (list
  (entity :text "Mais" :label "ORG" :start 0 :end 4) (entity :text "Maubant" :label "ORG" :start 57 :end 64) (entity :text "Théâtre-Français" :label "ORG" :start 90 :end 106) (entity :text "Sarah" :label "ORG" :start 563 :end 568) (entity :text "Bernhardt," :label "ORG" :start 569 :end 579) (entity :text "Berma," :label "ORG" :start 583 :end 589) (entity :text "Bartet," :label "ORG" :start 590 :end 597) (entity :text "Madeleine" :label "ORG" :start 598 :end 607) (entity :text "Brohan," :label "ORG" :start 608 :end 615) (entity :text "Jeanne" :label "ORG" :start 616 :end 622) (entity :text "Samary," :label "ORG" :start 623 :end 630) (entity :text "Souvent," :label "ORG" :start 1337 :end 1345) (entity :text "«Une" :label "ORG" :start 1448 :end 1452)
 )
 :sentences (list
  (sentence :text "Mais si les acteurs me préoccupaient ainsi, si la vue de Maubant
sortant un après-midi du Théâtre-Français m’avait causé le
saisissement et les souffrances de l’amour, combien le nom d’une
étoile flamboyant à la porte d’un théâtre, combien, à la glace d’un
coupé qui passait dans la rue avec ses chevaux fleuris de roses au
...
impuissant et douloureux pour me représenter sa vie! Je classais par
ordre de talent les plus illustres: Sarah Bernhardt, la Berma, Bartet,
Madeleine Brohan, Jeanne Samary, mais toutes m’intéressaient" :start 0 :end 658) (sentence :text "Or mon
oncle en connaissait beaucoup, et aussi des cocottes que je ne
distinguais pas nettement des actrices" :start 659 :end 768) (sentence :text "Il les recevait chez lui" :start 769 :end 794) (sentence :text "Et
si nous n’allions le voir qu’à certains jours c’est que, les autres
jours, venaient des femmes avec lesquelles sa famille n’aurait pas pu
se rencontrer, du moins à son avis à elle, car, pour mon oncle, au
contraire, sa trop grande facilité à faire à de jolies veuves qui
...
ronflant, qui n’était sans doute qu’un nom de guerre, la politesse de
les présenter à ma grand’mère ou même à leur donner des bijoux de
famille, l’avait déjà brouillé plus d’une fois avec mon grand-père" :start 795 :end 1335) (sentence :text "Souvent, à un nom d’actrice qui venait dans la conversation,
j’entendais mon père dire à ma mère, en souriant: «Une amie de ton
oncle»; et je pensais que le stage que peut-être pendant des années
des hommes importants faisaient inutilement à la porte de telle femme
qui ne répondait pas à leurs lettres et les faisait chasser par le
concierge de son hôtel, mon oncle aurait pu en dispenser un gamin
comme moi en le présentant chez lui à l’actrice, inapprochable à tant
d’autres, qui était pour lui une intime amie" :start 1336 :end 1850)
 ))
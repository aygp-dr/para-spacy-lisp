...
(text-analysis
 :text "Mais Swann se disait que s’il montrait à Odette (en consentant
...
d’un être particulier."
 :tokens 513
 :processed-at "2025-03-16T02:18:14.330339"
 :entities (list
  (entity :text "Mais" :label "ORG" :start 0 :end 4) (entity :text "Swann" :label "ORG" :start 5 :end 10) (entity :text "Odette" :label "ORG" :start 41 :end 47) (entity :text "Odette" :label "ORG" :start 300 :end 306) (entity :text "Verdurin." :label "ORG" :start 596 :end 605) (entity :text "Rémi" :label "ORG" :start 686 :end 690) (entity :text "Swann" :label "ORG" :start 727 :end 732) (entity :text "Verdurin." :label "ORG" :start 815 :end 824) (entity :text "Verdurin" :label "ORG" :start 854 :end 862) (entity :text "Vinteuil" :label "ORG" :start 1039 :end 1047) (entity :text "Pieter" :label "ORG" :start 1296 :end 1302) (entity :text "Hooch," :label "ORG" :start 1306 :end 1312) (entity :text "Elle" :label "ORG" :start 1553 :end 1557) (entity :text "Swann" :label "ORG" :start 1675 :end 1680) (entity :text "Elle" :label "ORG" :start 1733 :end 1737) (entity :text "Dans" :label "ORG" :start 1809 :end 1813) (entity :text "Mais" :label "ORG" :start 1912 :end 1916) (entity :text "Verdurin" :label "ORG" :start 2217 :end 2225) (entity :text "Odette" :label "ORG" :start 2271 :end 2277) (entity :text "Odette," :label "ORG" :start 2344 :end 2351)
 )
 :sentences (list
  (sentence :text "Mais Swann se disait que s’il montrait à Odette (en consentant
seulement à la retrouver après dîner), qu’il y avait des plaisirs
qu’il préférait à celui d’être avec elle, le goût qu’elle ressentait
pour lui ne connaîtrait pas de longtemps la satiété" :start 0 :end 249) (sentence :text "Et, d’autre part,
préférant infiniment à celle d’Odette, la beauté d’une petite ouvrière
fraîche et bouffie comme une rose et dont il était épris, il aimait
mieux passer le commencement de la soirée avec elle, étant sûr de voir
Odette ensuite" :start 250 :end 493) (sentence :text "C’est pour les mêmes raisons qu’il n’acceptait jamais
qu’Odette vînt le chercher pour aller chez les Verdurin" :start 494 :end 604) (sentence :text "La petite
ouvrière l’attendait près de chez lui à un coin de rue que son cocher
Rémi connaissait, elle montait à côté de Swann et restait dans ses
bras jusqu’au moment où la voiture l’arrêtait devant chez les
Verdurin" :start 605 :end 823) (sentence :text "A son entrée, tandis que Mme Verdurin montrant des roses
qu’il avait envoyées le matin lui disait: «Je vous gronde» et lui
indiquait une place à côté d’Odette, le pianiste jouait pour eux deux,
la petite phrase de Vinteuil qui était comme l’air national de leur
amour" :start 824 :end 1092) (sentence :text "Il commençait par la tenue des trémolos de violon que pendant
quelques mesures on entend seuls, occupant tout le premier plan, puis
tout d’un coup ils semblaient s’écarter et comme dans ces tableaux de
Pieter de Hooch, qu’approfondit le cadre étroit d’une porte
entr’ouverte, tout au loin, d’une couleur autre, dans le velouté d’une
lumière interposée, la petite phrase apparaissait, dansante,
pastorale, intercalée, épisodique, appartenant à un autre monde" :start 1093 :end 1551) (sentence :text "Elle
passait à plis simples et immortels, distribuant çà et là les dons de
sa grâce, avec le même ineffable sourire; mais Swann y croyait
distinguer maintenant du désenchantement" :start 1552 :end 1731) (sentence :text "Elle semblait connaître la
vanité de ce bonheur dont elle montrait la voie" :start 1732 :end 1807) (sentence :text "Dans sa grâce légère,
elle avait quelque chose d’accompli, comme le détachement qui succède
au regret" :start 1808 :end 1910) (sentence :text "Mais peu lui importait, il la considérait moins en
elle-même,--en ce qu’elle pouvait exprimer pour un musicien qui
ignorait l’existence et de lui et d’Odette quand il l’avait composée,
et pour tous ceux qui l’entendraient dans des siècles--, que comme un
gage, un souvenir de son amour qui, même pour les Verdurin que pour le
...
unissait; c’était au point que, comme Odette, par caprice, l’en avait
prié, il avait renoncé à son projet de se faire jouer par un artiste
la sonate entière, dont il continua à ne connaître que ce passage" :start 1911 :end 2510) (sentence :text "«Qu’avez-vous besoin du reste? lui avait-elle dit" :start 2511 :end 2561) (sentence :text "C’est ça notre
morceau" :start 2562 :end 2585) (sentence :text "» Et même, souffrant de songer, au moment où elle passait si
proche et pourtant à l’infini, que tandis qu’elle s’adressait à eux,
elle ne les connaissait pas, il regrettait presque qu’elle eût une
signification, une beauté intrinsèque et fixe, étrangère à eux, comme
en des bijoux donnés, ou même en des lettres écrites par une femme
aimée, nous en voulons à l’eau de la gemme, et aux mots du langage, de
ne pas être faits uniquement de l’essence d’une liaison passagère et
d’un être particulier" :start 2586 :end 3081)
 ))
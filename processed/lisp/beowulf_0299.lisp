...
(text-analysis
 :text "Car il y avait autour de Combray deux «côtés» pour les promenades, et
...
différents."
 :tokens 472
 :processed-at "2025-03-16T02:18:14.100301"
 :entities (list
  (entity :text "Combray" :label "ORG" :start 25 :end 32) (entity :text "Swann" :label "ORG" :start 261 :end 266) (entity :text "Swann" :label "ORG" :start 313 :end 318) (entity :text "Guermantes." :label "ORG" :start 352 :end 363) (entity :text "Combray," :label "ORG" :start 498 :end 506) (entity :text "Méséglise»." :label "ORG" :start 651 :end 662) (entity :text "Quant" :label "ORG" :start 663 :end 668) (entity :text "Guermantes" :label "ORG" :start 671 :end 681) (entity :text "Méséglise" :label "ORG" :start 792 :end 801) (entity :text "Combray," :label "ORG" :start 967 :end 975) (entity :text "Guermantes" :label "ORG" :start 976 :end 986) (entity :text "Guermantes»" :label "ORG" :start 1197 :end 1208) (entity :text "Méséglise," :label "ORG" :start 1222 :end 1232) (entity :text "Comme" :label "ORG" :start 1343 :end 1348) (entity :text "Méséglise" :label "ORG" :start 1386 :end 1395) (entity :text "Guermantes" :label "ORG" :start 1460 :end 1470) (entity :text "Mais" :label "ORG" :start 2111 :end 2115) (entity :text "Méséglise," :label "ORG" :start 2581 :end 2591) (entity :text "Guermantes," :label "ORG" :start 2612 :end 2623)
 )
 :sentences (list
  (sentence :text "Car il y avait autour de Combray deux «côtés» pour les promenades, et
si opposés qu’on ne sortait pas en effet de chez nous par la même
porte, quand on voulait aller d’un côté ou de l’autre: le côté de
Méséglise-la-Vineuse, qu’on appelait aussi le côte de chez Swann parce
qu’on passait devant la propriété de M" :start 0 :end 311) (sentence :text "Swann pour aller par là, et le
côté de Guermantes" :start 312 :end 362) (sentence :text "De Méséglise-la-Vineuse, à vrai dire, je n’ai
jamais connu que le «côté» et des gens étrangers qui venaient le
dimanche se promener à Combray, des gens que, cette fois, ma tante
elle-même et nous tous ne «connaissions point» et qu’à ce signe on
tenait pour «des gens qui seront venus de Méséglise»" :start 363 :end 661) (sentence :text "Quant à
Guermantes je devais un jour en connaître davantage, mais bien plus
tard seulement; et pendant toute mon adolescence, si Méséglise était
pour moi quelque chose d’inaccessible comme l’horizon, dérobé à la
vue, si loin qu’on allât, par les plis d’un terrain qui ne ressemblait
...
le terme plutôt idéal que réel de son propre «côté», une sorte
d’expression géographique abstraite comme la ligne de l’équateur,
comme le pôle, comme l’orient" :start 662 :end 1175) (sentence :text "Alors, «prendre par Guermantes» pour
aller à Méséglise, ou le contraire, m’eût semblé une expression aussi
dénuée de sens que prendre par l’est pour aller à l’ouest" :start 1176 :end 1341) (sentence :text "Comme mon
père parlait toujours du côté de Méséglise comme de la plus belle vue
de plaine qu’il connût et du côté de Guermantes comme du type de
paysage de rivière, je leur donnais, en les concevant ainsi comme deux
entités, cette cohésion, cette unité qui n’appartiennent qu’aux
...
rivière, ne valaient pas plus la peine d’être regardés que par le
spectateur épris d’art dramatique, les petites rues qui avoisinent un
théâtre" :start 1342 :end 2109) (sentence :text "Mais surtout je mettais entre eux, bien plus que leurs
distances kilométriques la distance qu’il y avait entre les deux
parties de mon cerveau où je pensais à eux, une de ces distances dans
l’esprit qui ne font pas qu’éloigner, qui séparent et mettent dans un
autre plan" :start 2110 :end 2381) (sentence :text "Et cette démarcation était rendue plus absolue encore
parce que cette habitude que nous avions de n’aller jamais vers les
deux côtés un même jour, dans une seule promenade, mais une fois du
côté de Méséglise, une fois du côté de Guermantes, les enfermait pour
ainsi dire loin l’un de l’autre, inconnaissables l’un à l’autre, dans
les vases clos et sans communication entre eux, d’après-midi
différents" :start 2382 :end 2784)
 ))
...
(text-analysis
 :text "Souvent aussi nous allions nous abriter, pêle-mêle avec les Saints et
...
ostensoir d’autel, les tiges d’or effrangées de son soleil reparu."
 :tokens 586
 :processed-at "2025-03-16T02:18:14.135783"
 :entities (list
  (entity :text "Souvent" :label "ORG" :start 0 :end 7) (entity :text "Saints" :label "ORG" :start 60 :end 66) (entity :text "Patriarches" :label "ORG" :start 74 :end 85) (entity :text "Saints," :label "ORG" :start 199 :end 206) (entity :text "Françoise." :label "ORG" :start 355 :end 365) (entity :text "Virgile" :label "ORG" :start 443 :end 450) (entity :text "Françoise" :label "ORG" :start 472 :end 481) (entity :text "Louis" :label "ORG" :start 523 :end 528) (entity :text "Combray" :label "ORG" :start 1047 :end 1054) (entity :text "Théodore," :label "ORG" :start 1179 :end 1188) (entity :text "Camus." :label "ORG" :start 1207 :end 1213) (entity :text "Françoise" :label "ORG" :start 1214 :end 1223) (entity :text "Léonie" :label "ORG" :start 1305 :end 1311) (entity :text "Françoise" :label "ORG" :start 1339 :end 1348) (entity :text "Théodore." :label "ORG" :start 1518 :end 1527) (entity :text "Françoise" :label "ORG" :start 1707 :end 1716) (entity :text "Vierge" :label "ORG" :start 1946 :end 1952) (entity :text "Théodore," :label "ORG" :start 2208 :end 2217) (entity :text "Cette" :label "ORG" :start 2719 :end 2724) (entity :text "Devant" :label "ORG" :start 3125 :end 3131) (entity :text "Roussainville," :label "ORG" :start 3182 :end 3196) (entity :text "Roussainville," :label "ORG" :start 3242 :end 3256) (entity :text "Bible" :label "ORG" :start 3356 :end 3361) (entity :text "Dieu" :label "ORG" :start 3487 :end 3491) (entity :text "Père" :label "ORG" :start 3495 :end 3499)
 )
 :sentences (list
  (sentence :text "Souvent aussi nous allions nous abriter, pêle-mêle avec les Saints et
les Patriarches de pierre sous le porche de Saint-André-des-Champs" :start 0 :end 136) (sentence :text "Que cette église était française! Au-dessus de la porte, les Saints,
les rois-chevaliers une fleur de lys à la main, des scènes de noces et
de funérailles, étaient représentés comme ils pouvaient l’être dans
l’âme de Françoise" :start 137 :end 364) (sentence :text "Le sculpteur avait aussi narré certaines anecdotes
relatives à Aristote et à Virgile de la même façon que Françoise à la
cuisine parlait volontiers de saint Louis comme si elle l’avait
personnellement connu, et généralement pour faire honte par la
comparaison à mes grands-parents moins «justes»" :start 365 :end 661) (sentence :text "On sentait que les
notions que l’artiste médiéval et la paysanne médiévale (survivant au
XIXe siècle) avaient de l’histoire ancienne ou chrétienne, et qui se
distinguaient par autant d’inexactitude que de bonhomie, ils les
tenaient non des livres, mais d’une tradition à la fois antique et
directe, ininterrompue, orale, déformée, méconnaissable et vivante" :start 662 :end 1019) (sentence :text "Une autre personnalité de Combray que je reconnaissais aussi,
virtuelle et prophétisée, dans la sculpture gothique de
Saint-André-des-Champs c’était le jeune Théodore, le garçon de chez
Camus" :start 1020 :end 1212) (sentence :text "Françoise sentait d’ailleurs si bien en lui un pays et un
contemporain que, quand ma tante Léonie était trop malade pour que
Françoise pût suffire à la retourner dans son lit, à la porter dans
son fauteuil, plutôt que de laisser la fille de cuisine monter se
faire «bien voir» de ma tante, elle appelait Théodore" :start 1213 :end 1526) (sentence :text "Or, ce garçon
qui passait et avec raison pour si mauvais sujet, était tellement
rempli de l’âme qui avait décoré Saint-André-des-Champs et notamment
des sentiments de respect que Françoise trouvait dus aux «pauvres
malades», à «sa pauvre maîtresse», qu’il avait pour soulever la tête
...
ensommeillement, qu’une réserve, prête à refleurir dans la vie en
innombrables visages populaires, révérends et futés comme celui de
Théodore, enluminés de la rougeur d’une pomme mûre" :start 1527 :end 2258) (sentence :text "Non plus appliquée
à la pierre comme ces petits anges, mais détachée du porche, d’une
stature plus qu’humaine, debout sur un socle comme sur un tabouret qui
lui évitât de poser ses pieds sur le sol humide, une sainte avait les
joues pleines, le sein ferme et qui gonflait la draperie comme une
grappe mûre dans un sac de crin, le front étroit, le nez court et
mutin, les prunelles enfoncées, l’air valide, insensible et courageux
des paysannes de la contrée" :start 2259 :end 2717) (sentence :text "Cette ressemblance qui insinuait dans la
statue une douceur que je n’y avais pas cherchée, était souvent
certifiée par quelque fille des champs, venue comme nous se mettre à
couvert et dont la présence, pareille à celle de ces feuillages
pariétaires qui ont poussé à côté des feuillages sculptés, semblait
destinée à permettre, par une confrontation avec la nature, de juger
de la vérité de l’œuvre d’art" :start 2718 :end 3123) (sentence :text "Devant nous, dans le lointain, terre
promise ou maudite, Roussainville, dans les murs duquel je n’ai jamais
pénétré, Roussainville, tantôt, quand la pluie avait déjà cessé pour
nous, continuait à être châtié comme un village de la Bible par toutes
les lances de l’orage qui flagellaient obliquement les demeures de ses
habitants, ou bien était déjà pardonné par Dieu le Père qui faisait
descendre vers lui, inégalement longues, comme les rayons d’un
ostensoir d’autel, les tiges d’or effrangées de son soleil reparu" :start 3124 :end 3640)
 ))
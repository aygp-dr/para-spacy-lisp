...
(text-analysis
 :text "C’est qu’elle n’avait même pas pensé à lui. Et de tels moments où elle
...
vingt ans."
 :tokens 639
 :processed-at "2025-03-16T02:18:14.591772"
 :entities (list
  (entity :text "Swann" :label "ORG" :start 103 :end 108) (entity :text "Odette," :label "ORG" :start 131 :end 138) (entity :text "Swann," :label "ORG" :start 170 :end 176) (entity :text "Swann" :label "ORG" :start 213 :end 218) (entity :text "Odette" :label "ORG" :start 355 :end 361) (entity :text "Verdurin" :label "ORG" :start 371 :end 379) (entity :text "Combray" :label "ORG" :start 450 :end 457) (entity :text "Swann" :label "ORG" :start 583 :end 588) (entity :text "Odette;" :label "ORG" :start 606 :end 613) (entity :text "Paris" :label "ORG" :start 700 :end 705) (entity :text "Mais" :label "ORG" :start 865 :end 869) (entity :text "Swann," :label "ORG" :start 989 :end 995) (entity :text "Dieu»," :label "ORG" :start 1063 :end 1069) (entity :text "Mais" :label "ORG" :start 1253 :end 1257) (entity :text "Philibert" :label "ORG" :start 1505 :end 1514) (entity :text "Beau" :label "ORG" :start 1518 :end 1522) (entity :text "Brou," :label "ORG" :start 1544 :end 1549) (entity :text "Marguerite" :label "ORG" :start 1590 :end 1600) (entity :text "Certains" :label "ORG" :start 1643 :end 1651) (entity :text "Odette:" :label "ORG" :start 2015 :end 2022) (entity :text "Lapérouse." :label "ORG" :start 2023 :end 2033) (entity :text "Quelquefois," :label "ORG" :start 2034 :end 2046) (entity :text "Paris." :label "ORG" :start 2184 :end 2190) (entity :text "Odette" :label "ORG" :start 2458 :end 2464) (entity :text "Mais" :label "ORG" :start 2821 :end 2825) (entity :text "Swann" :label "ORG" :start 2843 :end 2848) (entity :text "Odette" :label "ORG" :start 3053 :end 3059) (entity :text "Pour" :label "ORG" :start 3290 :end 3294) (entity :text "Odette" :label "ORG" :start 3452 :end 3458)
 )
 :sentences (list
  (sentence :text "C’est qu’elle n’avait même pas pensé à lui" :start 0 :end 42) (sentence :text "Et de tels moments où elle
oubliait jusqu’à l’existence de Swann étaient plus utiles à Odette,
servaient mieux à lui attacher Swann, que toute sa coquetterie" :start 43 :end 201) (sentence :text "Car
ainsi Swann vivait dans cette agitation douloureuse qui avait déjà été
assez puissante pour faire éclore son amour le soir où il n’avait pas
trouvé Odette chez les Verdurin et l’avait cherchée toute la soirée" :start 202 :end 415) (sentence :text "Et il n’avait pas, comme j’eus à Combray dans mon enfance, des
journées heureuses pendant lesquelles s’oublient les souffrances qui
renaîtront le soir" :start 416 :end 567) (sentence :text "Les journées, Swann les passait sans Odette; et
par moments il se disait que laisser une aussi jolie femme sortir
ainsi seule dans Paris était aussi imprudent que de poser un écrin
plein de bijoux au milieu de la rue" :start 568 :end 785) (sentence :text "Alors il s’indignait contre tous
les passants comme contre autant de voleurs" :start 786 :end 863) (sentence :text "Mais leur visage
collectif et informe échappant à son imagination ne nourrissait pas sa
jalousie" :start 864 :end 961) (sentence :text "Il fatiguait la pensée de Swann, lequel, se passant la main
sur les yeux, s’écriait: «À la grâce de Dieu», comme ceux qui après
s’être acharnés à étreindre le problème de la réalité du monde
extérieur ou de l’immortalité de l’âme accordent la détente d’un acte
de foi à leur cerveau lassé" :start 962 :end 1251) (sentence :text "Mais toujours la pensée de l’absente
était indissolublement mêlée aux actes les plus simples de la vie de
Swann,--déjeuner, recevoir son courrier, sortir, se coucher,--par la
tristesse même qu’il avait à les accomplir sans elle, comme ces
initiales de Philibert le Beau que dans l’église de Brou, à cause du
regret qu’elle avait de lui, Marguerite d’Autriche entrelaça partout
aux siennes" :start 1252 :end 1641) (sentence :text "Certains jours, au lieu de rester chez lui, il allait
prendre son déjeuner dans un restaurant assez voisin dont il avait
apprécié autrefois la bonne cuisine et où maintenant il n’allait plus
que pour une de ces raisons, à la fois mystiques et saugrenues, qu’on
appelle romanesques; c’est que ce restaurant (lequel existe encore)
portait le même nom que la rue habitée par Odette: Lapérouse" :start 1642 :end 2032) (sentence :text "Quelquefois, quand elle avait fait un court déplacement ce n’est
qu’après plusieurs jours qu’elle songeait à lui faire savoir qu’elle
était revenue à Paris" :start 2033 :end 2189) (sentence :text "Et elle lui disait tout simplement, sans plus
prendre comme autrefois la précaution de se couvrir à tout hasard d’un
petit morceau emprunté à la vérité, qu’elle venait d’y rentrer à
l’instant même par le train du matin" :start 2190 :end 2409) (sentence :text "Ces paroles étaient mensongères;
du moins pour Odette elles étaient mensongères, inconsistantes,
n’ayant pas, comme si elles avaient été vraies, un point d’appui dans
le souvenir de son arrivée à la gare; même elle était empêchée de se
les représenter au moment où elle les prononçait, par l’image
contradictoire de ce qu’elle avait fait de tout différent au moment où
elle prétendait être descendue du train" :start 2410 :end 2819) (sentence :text "Mais dans l’esprit de Swann
au contraire ces paroles qui ne rencontraient aucun obstacle venaient
s’incruster et prendre l’inamovibilité d’une vérité si indubitable que
si un ami lui disait être venu par ce train et ne pas avoir vu Odette
il était persuadé que c’était l’ami qui se trompait de jour ou d’heure
puisque son dire ne se conciliait pas avec les paroles d’Odette" :start 2820 :end 3194) (sentence :text "Celles-ci ne lui eussent paru mensongères que s’il s’était d’abord
défié qu’elles le fussent" :start 3195 :end 3288) (sentence :text "Pour qu’il crût qu’elle mentait, un soupçon
préalable était une condition nécessaire" :start 3289 :end 3374) (sentence :text "C’était d’ailleurs aussi une
condition suffisante" :start 3375 :end 3425) (sentence :text "Alors tout ce que disait Odette lui paraissait
suspect" :start 3426 :end 3481) (sentence :text "L’entendait-il citer un nom, c’était certainement celui d’un
de ses amants; une fois cette supposition forgée, il passait des
semaines à se désoler; il s’aboucha même une fois avec une agence de
renseignements pour savoir l’adresse, l’emploi du temps de l’inconnu
qui ne le laisserait respirer que quand il serait parti en voyage, et
dont il finit par apprendre que c’était un oncle d’Odette mort depuis
vingt ans" :start 3482 :end 3896)
 ))
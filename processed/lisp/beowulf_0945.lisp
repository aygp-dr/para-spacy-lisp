...
(text-analysis
 :text "Mais elle vit que ses yeux restaient fixés sur les choses qu’il ne
...
autre forme."
 :tokens 967
 :processed-at "2025-03-16T02:18:14.790825"
 :entities (list
  (entity :text "Mais" :label "ORG" :start 0 :end 4) (entity :text "Bois," :label "ORG" :start 241 :end 246) (entity :text "Laumes." :label "ORG" :start 302 :end 309) (entity :text "Mais" :label "ORG" :start 310 :end 314) (entity :text "Voilà" :label "ORG" :start 687 :end 692) (entity :text "Mais" :label "ORG" :start 984 :end 988) (entity :text "«Deux" :label "ORG" :start 1328 :end 1333) (entity :text "«Cette" :label "ORG" :start 1350 :end 1356) (entity :text "Swann," :label "ORG" :start 1425 :end 1431) (entity :text "Pendant" :label "ORG" :start 1499 :end 1506) (entity :text "«Cette" :label "ORG" :start 1674 :end 1680) (entity :text "Odette." :label "ORG" :start 1998 :end 2005) (entity :text "Mais" :label "ORG" :start 2006 :end 2010) (entity :text "«Vilain" :label "ORG" :start 2221 :end 2228) (entity :text "Odette" :label "ORG" :start 2366 :end 2372) (entity :text "Pauvre" :label "ORG" :start 2529 :end 2535) (entity :text "Odette!" :label "ORG" :start 2536 :end 2543) (entity :text "Elle" :label "ORG" :start 2570 :end 2574) (entity :text "Nice," :label "ORG" :start 2695 :end 2700) (entity :text "Mais" :label "ORG" :start 2721 :end 2725) (entity :text "Journal" :label "ORG" :start 2783 :end 2790) (entity :text "Poète" :label "ORG" :start 2796 :end 2801) (entity :text "Vigny" :label "ORG" :start 2814 :end 2819) (entity :text "«Quand" :label "ORG" :start 2866 :end 2872) (entity :text "Comment" :label "ORG" :start 2933 :end 2940) (entity :text "Quelle" :label "ORG" :start 2960 :end 2966) (entity :text "Tout" :label "ORG" :start 2981 :end 2985) (entity :text "Swann" :label "ORG" :start 3030 :end 3035) (entity :text "«Cette" :label "ORG" :start 3099 :end 3105) (entity :text "Mais" :label "ORG" :start 3184 :end 3188) (entity :text "Mais" :label "ORG" :start 4135 :end 4139) (entity :text "Odette," :label "ORG" :start 4238 :end 4245) (entity :text "Swann" :label "ORG" :start 4288 :end 4293) (entity :text "Laumes" :label "ORG" :start 4474 :end 4480) (entity :text "Verdurin" :label "ORG" :start 4724 :end 4732) (entity :text "Bois" :label "ORG" :start 4771 :end 4775) (entity :text "Mais" :label "ORG" :start 5247 :end 5251) (entity :text "Bois," :label "ORG" :start 5587 :end 5592) (entity :text "Laumes," :label "ORG" :start 5613 :end 5620) (entity :text "Odette" :label "ORG" :start 5694 :end 5700)
 )
 :sentences (list
  (sentence :text "Mais elle vit que ses yeux restaient fixés sur les choses qu’il ne
savait pas et sur ce passé de leur amour, monotone et doux dans sa
mémoire parce qu’il était vague, et que déchirait maintenant comme une
blessure cette minute dans l’île du Bois, au clair de lune, après le
dîner chez la princesse des Laumes" :start 0 :end 308) (sentence :text "Mais il avait tellement pris
l’habitude de trouver la vie intéressante--d’admirer les curieuses
découvertes qu’on peut y faire--que tout en souffrant au point de
croire qu’il ne pourrait pas supporter longtemps une pareille douleur,
il se disait: «La vie est vraiment étonnante et réserve de belles
surprises; en somme le vice est quelque chose de plus répandu qu’on ne
croit" :start 309 :end 685) (sentence :text "Voilà une femme en qui j’avais confiance, qui a l’air si
simple, si honnête, en tous cas, si même elle était légère, qui
semblait bien normale et saine dans ses goûts: sur une dénonciation
invraisemblable, je l’interroge et le peu qu’elle m’avoue révèle bien
plus que ce qu’on eût pu soupçonner" :start 686 :end 981) (sentence :text "» Mais il ne pouvait pas se borner
à ces remarques désintéressées" :start 982 :end 1047) (sentence :text "Il cherchait à apprécier exactement la
valeur de ce qu’elle lui avait raconté, afin de savoir s’il devait
conclure que ces choses, elle les avait faites souvent, qu’elles se
renouvelleraient" :start 1048 :end 1239) (sentence :text "Il se répétait ces mots qu’elle avait dits: «Je
voyais bien où elle voulait en venir», «Deux ou trois fois», «Cette
blague!» mais ils ne reparaissaient pas désarmés dans la mémoire de
Swann, chacun d’eux tenait son couteau et lui en portait un nouveau
coup" :start 1240 :end 1497) (sentence :text "Pendant bien longtemps, comme un malade ne peut s’empêcher
d’essayer à toute minute de faire le mouvement qui lui est douloureux,
il se redisait ces mots: «Je suis bien ici», «Cette blague!», mais la
souffrance était si forte qu’il était obligé de s’arrêter" :start 1498 :end 1756) (sentence :text "Il
s’émerveillait que des actes que toujours il avait jugés si
légèrement, si gaiement, maintenant fussent devenus pour lui graves
comme une maladie dont on peut mourir" :start 1757 :end 1926) (sentence :text "Il connaissait bien des femmes
à qui il eût pu demander de surveiller Odette" :start 1927 :end 2004) (sentence :text "Mais comment espérer
qu’elles se placeraient au même point de vue que lui et ne resteraient
pas à celui qui avait été si longtemps le sien, qui avait toujours
guidé sa vie voluptueuse, ne lui diraient pas en riant: «Vilain jaloux
qui veut priver les autres d’un plaisir" :start 2005 :end 2275) (sentence :text "» Par quelle trappe
soudainement abaissée (lui qui n’avait eu autrefois de son amour pour
Odette que des plaisirs délicats) avait-il été brusquement précipité
dans ce nouveau cercle de l’enfer d’où il n’apercevait pas comment il
pourrait jamais sortir" :start 2276 :end 2527) (sentence :text "Pauvre Odette! il ne lui en voulait pas" :start 2528 :end 2568) (sentence :text "Elle
n’était qu’à demi coupable" :start 2569 :end 2601) (sentence :text "Ne disait-on pas que c’était par sa propre
mère qu’elle avait été livrée, presque enfant, à Nice, à un riche
Anglais" :start 2602 :end 2719) (sentence :text "Mais quelle vérité douloureuse prenait pour lui ces lignes du
Journal d’un Poète d’Alfred de Vigny qu’il avait lues avec
indifférence autrefois: «Quand on se sent pris d’amour pour une femme,
on devrait se dire: Comment est-elle entourée? Quelle a été sa vie?
Tout le bonheur de la vie est appuyé là-dessus" :start 2720 :end 3027) (sentence :text "» Swann s’étonnait que
de simples phrases épelées par sa pensée, comme «Cette blague!», «Je
voyais bien où elle voulait en venir» pussent lui faire si mal" :start 3028 :end 3182) (sentence :text "Mais
il comprenait que ce qu’il croyait de simples phrases n’était que les
pièces de l’armature entre lesquelles tenait, pouvait lui être rendue,
la souffrance qu’il avait éprouvée pendant le récit d’Odette" :start 3183 :end 3390) (sentence :text "Car
c’était bien cette souffrance-là qu’il éprouvait de nouveau" :start 3391 :end 3455) (sentence :text "Il avait
beau savoir maintenant,--même, il eut beau, le temps passant, avoir un
peu oublié, avoir pardonné--, au moment où il se redisait ses mots, la
souffrance ancienne le refaisait tel qu’il était avant qu’Odette ne
parlât: ignorant, confiant; sa cruelle jalousie le replaçait pour le
faire frapper par l’aveu d’Odette dans la position de quelqu’un qui ne
sait pas encore, et au bout de plusieurs mois cette vieille histoire
le bouleversait toujours comme une révélation" :start 3456 :end 3930) (sentence :text "Il admirait la terrible
puissance recréatrice de sa mémoire" :start 3931 :end 3991) (sentence :text "Ce n’est que de l’affaiblissement
de cette génératrice dont la fécondité diminue avec l’âge qu’il
pouvait espérer un apaisement à sa torture" :start 3992 :end 4133) (sentence :text "Mais quand paraissait un
peu épuisé le pouvoir qu’avait de le faire souffrir un des mots
prononcés par Odette, alors un de ceux sur lesquels l’esprit de Swann
s’était moins arrêté jusque-là, un mot presque nouveau venait relayer
les autres et le frappait avec une vigueur intacte" :start 4134 :end 4414) (sentence :text "La mémoire du soir
où il avait dîné chez la princesse des Laumes lui était douloureuse,
mais ce n’était que le centre de son mal" :start 4415 :end 4544) (sentence :text "Celui-ci irradiait
confusément à l’entour dans tous les jours avoisinants" :start 4545 :end 4619) (sentence :text "Et à quelque
point d’elle qu’il voulût toucher dans ses souvenirs, c’est la saison
tout entière où les Verdurin avaient si souvent dîné dans l’île du
Bois qui lui faisait mal" :start 4620 :end 4795) (sentence :text "Si mal que peu à peu les curiosités
qu’excitait en lui sa jalousie furent neutralisées par la peur des
tortures nouvelles qu’il s’infligerait en les satisfaisant" :start 4796 :end 4958) (sentence :text "Il se
rendait compte que toute la période de la vie d’Odette écoulée avant
qu’elle ne le rencontrât, période qu’il n’avait jamais cherché à se
représenter, n’était pas l’étendue abstraite qu’il voyait vaguement,
mais avait été faite d’années particulières, remplie d’incidents
concrets" :start 4959 :end 5245) (sentence :text "Mais en les apprenant, il craignait que ce passé incolore,
fluide et supportable, ne prît un corps tangible et immonde, un visage
individuel et diabolique" :start 5246 :end 5401) (sentence :text "Et il continuait à ne pas chercher à le
concevoir non plus par paresse de penser, mais par peur de souffrir" :start 5402 :end 5510) (sentence :text "Il espérait qu’un jour il finirait par pouvoir entendre le nom de
l’île du Bois, de la princesse des Laumes, sans ressentir le
déchirement ancien, et trouvait imprudent de provoquer Odette à lui
fournir de nouvelles paroles, le nom d’endroits, de circonstances
différentes qui, son mal à peine calmé, le feraient renaître sous une
autre forme" :start 5511 :end 5854)
 ))
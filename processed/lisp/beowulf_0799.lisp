...
(text-analysis
 :text "Il arrivait encore parfois, quand, ayant rencontré Swann, elle voyait
...
disait:"
 :tokens 324
 :processed-at "2025-03-16T02:18:14.638196"
 :entities (list
  (entity :text "Swann," :label "ORG" :start 51 :end 57) (entity :text "Forcheville" :label "ORG" :start 252 :end 263) (entity :text "Mais" :label "ORG" :start 274 :end 278) (entity :text "Swann," :label "ORG" :start 412 :end 418) (entity :text "«Mon" :label "ORG" :start 720 :end 724) (entity :text "Swann" :label "ORG" :start 899 :end 904) (entity :text "Quand" :label "ORG" :start 986 :end 991) (entity :text "«Vous" :label "ORG" :start 1329 :end 1334) (entity :text "Dans" :label "ORG" :start 1480 :end 1484) (entity :text "«Vous," :label "ORG" :start 1554 :end 1560) (entity :text "Swann" :label "ORG" :start 1695 :end 1700)
 )
 :sentences (list
  (sentence :text "Il arrivait encore parfois, quand, ayant rencontré Swann, elle voyait
s’approcher d’elle quelqu’un qu’il ne connaissait pas, qu’il pût
remarquer sur le visage d’Odette cette tristesse qu’elle avait eue le
jour où il était venu pour la voir pendant que Forcheville était là" :start 0 :end 272) (sentence :text "Mais c’était rare; car les jours où malgré tout ce qu’elle avait à
faire et la crainte de ce que penserait le monde, elle arrivait à voir
Swann, ce qui dominait maintenant dans son attitude était l’assurance:
grand contraste, peut-être revanche inconsciente ou réaction naturelle
de l’émotion craintive qu’aux premiers temps où elle l’avait connu,
...
que je peux à peine écrire» (elle le prétendait du moins et un peu de
cet émoi devait être sincère pour qu’elle désirât d’en feindre
davantage)" :start 273 :end 897) (sentence :text "Swann lui plaisait alors" :start 898 :end 923) (sentence :text "On ne tremble jamais que pour
soi, que pour ceux qu’on aime" :start 924 :end 984) (sentence :text "Quand notre bonheur n’est plus dans
leurs mains, de quel calme, de quelle aisance, de quelle hardiesse on
jouit auprès d’eux! En lui parlant, en lui écrivant, elle n’avait plus
de ces mots par lesquels elle cherchait à se donner l’illusion qu’il
lui appartenait, faisant naître les occasions de dire «mon», «mien»,
quand il s’agissait de lui: «Vous êtes mon bien, c’est le parfum de
notre amitié, je le garde», de lui parler de l’avenir, de la mort
même, comme d’une seule chose pour eux deux" :start 985 :end 1478) (sentence :text "Dans ce temps-là, à tout
de qu’il disait, elle répondait avec admiration: «Vous, vous ne serez
jamais comme tout le monde»; elle regardait sa longue tête un peu
chauve, dont les gens qui connaissaient les succès de Swann pensaient:
«Il n’est pas régulièrement beau si vous voulez, mais il est chic: ce

...
(text-analysis
 :text "S’il était assez simple d’aller du côté de Méséglise, c’était une
...
aujourd’hui le chef-d’œuvre de Vinci et le portail de Saint-Marc."
 :tokens 412
 :processed-at "2025-03-16T02:18:14.168493"
 :entities (list
  (entity :text "Méséglise," :label "ORG" :start 43 :end 53) (entity :text "Guermantes," :label "ORG" :start 99 :end 110) (entity :text "Quand" :label "ORG" :start 189 :end 194) (entity :text "Françoise" :label "ORG" :start 251 :end 260) (entity :text "«Demain" :label "ORG" :start 929 :end 936) (entity :text "Guermantes.»" :label "ORG" :start 984 :end 996) (entity :text "Perchamps," :label "ORG" :start 1097 :end 1107) (entity :text "Combray" :label "ORG" :start 1387 :end 1394) (entity :text "Mais" :label "ORG" :start 1450 :end 1454) (entity :text "Renaissance" :label "ORG" :start 1557 :end 1568) (entity :text "Perchamps." :label "ORG" :start 1776 :end 1786) (entity :text "Elle" :label "ORG" :start 1787 :end 1791) (entity :text "Combray" :label "ORG" :start 2060 :end 2067) (entity :text "Cène" :label "ORG" :start 2338 :end 2342) (entity :text "Gentile" :label "ORG" :start 2360 :end 2367) (entity :text "Bellini" :label "ORG" :start 2368 :end 2375) (entity :text "Vinci" :label "ORG" :start 2460 :end 2465) (entity :text "Saint-Marc." :label "ORG" :start 2483 :end 2494)
 )
 :sentences (list
  (sentence :text "S’il était assez simple d’aller du côté de Méséglise, c’était une
autre affaire d’aller du côté de Guermantes, car la promenade était
longue et l’on voulait être sûr du temps qu’il ferait" :start 0 :end 187) (sentence :text "Quand on
semblait entrer dans une série de beaux jours; quand Françoise
désespérée qu’il ne tombât pas une goutte d’eau pour les «pauvres
récoltes», et ne voyant que de rares nuages blancs nageant à la
surface calme et bleue du ciel s’écriait en gémissant: «Ne dirait-on
...
la mer»; quand mon père avait reçu invariablement les mêmes réponses
favorables du jardinier et du baromètre, alors on disait au dîner:
«Demain s’il fait le même temps, nous irons du côté de Guermantes" :start 188 :end 994) (sentence :text "» On
partait tout de suite après déjeuner par la petite porte du jardin et
on tombait dans la rue des Perchamps, étroite et formant un angle
aigu, remplie de graminées au milieu desquelles deux ou trois guêpes
passaient la journée à herboriser, aussi bizarre que son nom d’où me
semblaient dériver ses particularités curieuses et sa personnalité
revêche, et qu’on chercherait en vain dans le Combray d’aujourd’hui où
sur son tracé ancien s’élève l’école" :start 995 :end 1448) (sentence :text "Mais ma rêverie (semblable à ces
architectes élèves de Viollet-le-Duc, qui, croyant retrouver sous un
jubé Renaissance et un autel du XVIIe siècle les traces d’un chœur
roman, remettent tout l’édifice dans l’état où il devait être au XIIe
siècle) ne laisse pas une pierre du bâtiment nouveau, reperce et
«restitue» la rue des Perchamps" :start 1449 :end 1785) (sentence :text "Elle a d’ailleurs pour ces
reconstitutions, des données plus précises que n’en ont généralement
les restaurateurs: quelques images conservées par ma mémoire, les
dernières peut-être qui existent encore actuellement, et destinées à
être bientôt anéanties, de ce qu’était le Combray du temps de mon
...
reproductions--comme ces gravures anciennes de la Cène ou ce tableau de
Gentile Bellini dans lesquels l’on voit en un état qui n’existe plus
aujourd’hui le chef-d’œuvre de Vinci et le portail de Saint-Marc" :start 1786 :end 2493)
 ))
...
(text-analysis
 :text "J’aurais voulu prendre dès le lendemain le beau train généreux d’une
...
palais des Doges et de Sainte-Marie-des-Fleurs."
 :tokens 626
 :processed-at "2025-03-16T02:18:14.825988"
 :entities (list
  (entity :text "Compagnies" :label "ORG" :start 167 :end 177) (entity :text "Paris," :label "ORG" :start 492 :end 498) (entity :text "Bayeux," :label "ORG" :start 617 :end 624) (entity :text "Coutances," :label "ORG" :start 627 :end 637) (entity :text "Vitré," :label "ORG" :start 640 :end 646) (entity :text "Questambert," :label "ORG" :start 649 :end 661) (entity :text "Pontorson," :label "ORG" :start 664 :end 674) (entity :text "Balbec," :label "ORG" :start 677 :end 684) (entity :text "Lannion," :label "ORG" :start 687 :end 695) (entity :text "Lamballe," :label "ORG" :start 698 :end 707) (entity :text "Benodet," :label "ORG" :start 710 :end 718) (entity :text "Pont-Aven," :label "ORG" :start 721 :end 731) (entity :text "Quimperlé," :label "ORG" :start 734 :end 744) (entity :text "Mais" :label "ORG" :start 904 :end 908) (entity :text "Balbec" :label "ORG" :start 1038 :end 1044) (entity :text "Mais" :label "ORG" :start 1188 :end 1192) (entity :text "Pâques," :label "ORG" :start 1222 :end 1229) (entity :text "Combray" :label "ORG" :start 1848 :end 1855) (entity :text "Fiésole" :label "ORG" :start 1985 :end 1992) (entity :text "Florence" :label "ORG" :start 2008 :end 2016) (entity :text "Puis" :label "ORG" :start 2332 :end 2336) (entity :text "Bonheur." :label "ORG" :start 2814 :end 2822) (entity :text "Mais" :label "ORG" :start 2823 :end 2827) (entity :text "Balbec," :label "ORG" :start 3347 :end 3354) (entity :text "Venise," :label "ORG" :start 3355 :end 3362) (entity :text "Florence," :label "ORG" :start 3363 :end 3372) (entity :text "Même" :label "ORG" :start 3487 :end 3491) (entity :text "Balbec" :label "ORG" :start 3538 :end 3544) (entity :text "Florence" :label "ORG" :start 3658 :end 3666) (entity :text "Venise" :label "ORG" :start 3673 :end 3679) (entity :text "Doges" :label "ORG" :start 3734 :end 3739)
 )
 :sentences (list
  (sentence :text "J’aurais voulu prendre dès le lendemain le beau train généreux d’une
heure vingt-deux dont je ne pouvais jamais sans que mon cœur palpitât
lire, dans les réclames des Compagnies de chemin de fer, dans les
annonces de voyages circulaires, l’heure de départ: elle me semblait
inciser à un point précis de l’après-midi une savoureuse entaille, une
...
et s’avançait magnifiquement surchargé de noms qu’il m’offrait et
entre lesquels je ne savais lequel j’aurais préféré, par impossibilité
d’en sacrifier aucun" :start 0 :end 902) (sentence :text "Mais sans même l’attendre, j’aurais pu en
m’habillant à la hâte partir le soir même, si mes parents me l’avaient
permis, et arriver à Balbec quand le petit jour se lèverait sur la mer
furieuse, contre les écumes envolées de laquelle j’irais me réfugier
dans l’église de style persan" :start 903 :end 1186) (sentence :text "Mais à l’approche des vacances de
Pâques, quand mes parents m’eurent promis de me les faire passer une
fois dans le nord de l’Italie, voilà qu’à ces rêves de tempête dont
j’avais été rempli tout entier, ne souhaitant voir que des vagues
accourant de partout, toujours plus haut, sur la côte la plus sauvage,
...
aiguilles du givre, mais celui qui couvrait déjà de lys et d’anémones
les champs de Fiésole et éblouissait Florence de fonds d’or pareils à
ceux de l’Angelico" :start 1187 :end 2059) (sentence :text "Dès lors, seuls les rayons, les parfums, les
couleurs me semblaient avoir du prix; car l’alternance des images
avait amené en moi un changement de front du désir, et,--aussi brusque
que ceux qu’il y a parfois en musique, un complet changement de ton
dans ma sensibilité" :start 2060 :end 2330) (sentence :text "Puis il arriva qu’une simple variation
atmosphérique suffit à provoquer en moi cette modulation sans qu’il y
eût besoin d’attendre le retour d’une saison" :start 2331 :end 2485) (sentence :text "Car souvent dans l’une,
on trouve égaré un jour d’une autre, qui nous y fait vivre, en évoque
aussitôt, en fait désirer les plaisirs particuliers et interrompt les
rêves que nous étions en train de faire, en plaçant, plus tôt ou plus
tard qu’à son tour, ce feuillet détaché d’un autre chapitre, dans le
calendrier interpolé du Bonheur" :start 2486 :end 2821) (sentence :text "Mais bientôt comme ces phénomènes
naturels dont notre confort ou notre santé ne peuvent tirer qu’un
bénéfice accidentel et assez mince jusqu’au jour où la science
s’empare d’eux, et les produisant à volonté, remet en nos mains la
possibilité de leur apparition, soustraite à la tutelle et dispensée
de l’agrément du hasard, de même la production de ces rêves
d’Atlantique et d’Italie cessa d’être soumise uniquement aux
changements des saisons et du temps" :start 2822 :end 3278) (sentence :text "Je n’eus besoin pour les faire
renaître que de prononcer ces noms: Balbec, Venise, Florence, dans
l’intérieur desquels avait fini par s’accumuler le désir que m’avaient
inspiré les lieux qu’ils désignaient" :start 3279 :end 3485) (sentence :text "Même au printemps, trouver dans
un livre le nom de Balbec suffisait à réveiller en moi le désir des
tempêtes et du gothique normand; même par un jour de tempête le nom de
Florence ou de Venise me donnait le désir du soleil, des lys, du
palais des Doges et de Sainte-Marie-des-Fleurs" :start 3486 :end 3769)
 ))
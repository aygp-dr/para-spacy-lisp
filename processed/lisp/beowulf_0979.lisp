...
(text-analysis
 :text "Aussi si le ciel était douteux, dès le matin je ne cessais de
...
calme et de bonheur."
 :tokens 330
 :processed-at "2025-03-16T02:18:14.841163"
 :entities (list
  (entity :text "«Cette" :label "ORG" :start 208 :end 214) (entity :text "Gilberte" :label "ORG" :start 283 :end 291) (entity :text "Mais" :label "ORG" :start 330 :end 334) (entity :text "Champs-Élysées?" :label "ORG" :start 534 :end 549) (entity :text "Devant" :label "ORG" :start 663 :end 669) (entity :text "Tout" :label "ORG" :start 704 :end 708) (entity :text "Ouverture," :label "ORG" :start 1313 :end 1323)
 )
 :sentences (list
  (sentence :text "Aussi si le ciel était douteux, dès le matin je ne cessais de
l’interroger et je tenais compte de tous les présages" :start 0 :end 115) (sentence :text "Si je voyais la
dame d’en face qui, près de la fenêtre, mettait son chapeau, je me
disais: «Cette dame va sortir; donc il fait un temps où l’on peut
sortir: pourquoi Gilberte ne ferait-elle pas comme cette dame?» Mais
le temps s’assombrissait, ma mère disait qu’il pouvait se lever
...
probablement il pleuvrait; et s’il pleuvait à quoi bon aller aux
Champs-Élysées? Aussi depuis le déjeuner mes regards anxieux ne
quittaient plus le ciel incertain et nuageux" :start 116 :end 642) (sentence :text "Il restait sombre" :start 643 :end 661) (sentence :text "Devant la fenêtre, le balcon était gris" :start 662 :end 702) (sentence :text "Tout d’un coup, sur sa pierre
maussade je ne voyais pas une couleur moins terne, mais je sentais
comme un effort vers une couleur moins terne, la pulsation d’un rayon
hésitant qui voudrait libérer sa lumière" :start 703 :end 911) (sentence :text "Un instant après, le balcon
était pâle et réfléchissant comme une eau matinale, et mille reflets
de la ferronnerie de son treillage étaient venus s’y poser" :start 912 :end 1068) (sentence :text "Un souffle
de vent les dispersait, la pierre s’était de nouveau assombrie, mais,
comme apprivoisés, ils revenaient; elle recommençait imperceptiblement
à blanchir et par un de ces crescendos continus comme ceux qui, en
musique, à la fin d’une Ouverture, mènent une seule note jusqu’au
...
heureuses qu’en vérité ces reflets larges et feuillus qui reposaient
sur ce lac de soleil semblaient savoir qu’ils étaient des gages de
calme et de bonheur" :start 1069 :end 1994)
 ))